...
// ----- NativeGpio -----
void NativeGpio::pin_mode(int pin, int mode)
{
    modes_[pin] = mode;
}
...
void NativeGpio::write(int pin, bool value)
{
    values_[pin] = value;
}

void NativeGpio::set_pin(int pin, bool value)
{
    values_[pin] = value;
}
...
// ----- NativeSerial -----
void NativeSerial::init(int baud)
{
    baud_ = baud;
}
void NativeSerial::write(const char* s)
{
    buffer_ += s;
}
